...
print(len(set(first)), len(set(second)))
print(len(list(zip(first, second))))
print(sorted(first))
print(sorted(second))
...
w, h = im.size
# first starts and ends in the same point
it = iter(first[2:])
x1 = first[0]
y1 = first[1]
while True:
    try:
        ...
        break
# second starts and ends in different points, so we have to start with the last to get a closed polygon
it = iter(second)
x1 = second[-2]
y1 = second[-1]
while True:
